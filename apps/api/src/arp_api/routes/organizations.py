...
def list_organizations(
    ...
    return [
        organization_to_read(record)
        for record in services.list_organizations_for_actor(session, actor_user_id=actor.user_id)
    ]
...
def create_organization(
    ...
    organization = services.create_organization(session, payload, actor_user_id=actor.user_id)
